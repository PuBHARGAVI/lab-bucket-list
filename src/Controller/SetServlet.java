...
public class SetServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		HashSet<TouristPlace> places =null;
		if(add!=null) {
			// call the add method and store the return value in a set variable
			if(sortbydestination==null && sortbyrank==null) {
				places = set.add(touristobj);
				System.out.print("Hi");
				request.setAttribute("bucketList",places /*pass the return value */);
		...
		if(remove!=null) {
			...
			request.setAttribute("bucketList",set.remove(touristobj) /*pass the return value */);
			RequestDispatcher rd=this.getServletContext().getRequestDispatcher("/WEB-INF/views/set.jsp");
			rd.forward(request, response);
		}
		...
		if(sortbyrank!=null) {
			...
			request.setAttribute("bucketList", set.sortByRank(places)/*pass the return value */);
			RequestDispatcher rd=this.getServletContext().getRequestDispatcher("/WEB-INF/views/set.jsp");
			rd.forward(request, response);
		}
		...
		if(reset!=null) {
			...
			request.setAttribute("bucketList", set.reset((HashSet) places)/*pass the return value */);
			RequestDispatcher rd=this.getServletContext().getRequestDispatcher("/WEB-INF/views/set.jsp");
			rd.forward(request, response);
		}
